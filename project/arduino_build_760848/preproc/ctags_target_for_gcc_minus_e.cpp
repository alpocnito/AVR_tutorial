# 1 "/root/Arduino/sketch_feb16a/sketch_feb16a.ino"
/*
...
# 18 "/root/Arduino/sketch_feb16a/sketch_feb16a.ino" 2

# 20 "/root/Arduino/sketch_feb16a/sketch_feb16a.ino" 2

# 22 "/root/Arduino/sketch_feb16a/sketch_feb16a.ino" 2
...
success = nfc.readPassiveTargetID((0x00), &uid[0], &uidLength);
  ...
  if (success) {
...

    {
      ...
      Serial.print(" 0x");Serial.print(uid[i], 16);
